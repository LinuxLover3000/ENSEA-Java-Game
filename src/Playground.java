...
public class Playground {
    ...
    public Playground (String pathName){
        try{
            final Image imageTree = ImageIO.read(new File("./resource/img/tree.png")); // Adjusted paths
            final Image imageGrass = ImageIO.read(new File("./resource/img/grass.png"));
            final Image imageRock = ImageIO.read(new File("./resource/img/rock.png"));
            final Image imageTrap = ImageIO.read(new File("./resource/img/trap.png"));
